...
namespace лабораторная_7_по_методичке
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            textBox14.Text += "Переменная" + Environment.NewLine;
            textBox14.Text += "Сумма = " + znach + Environment.NewLine;
            textBox14.Text += "Произведение = " + znach + Environment.NewLine;
            textBox14.Text += "Сортировка = " + znach + Environment.NewLine;
            mass Ro = new mass();
            ...
            arrMultiply = Ran.Umn2(arr2, arr2);
            ...
            //textBox14.Text += "Сумма " + Ran.Plus2(arr2) + Environment.NewLine;
            int[,] arrSum = new int[arr2.GetLength(1), arr2.GetLength(0)];
            arrSum = Ran.Plus2(arr2, arr2);
